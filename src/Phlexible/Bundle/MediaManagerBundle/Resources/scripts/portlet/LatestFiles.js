...
Phlexible.mediamanager.portlet.LatestFilesSmallTemplate = new Ext.XTemplate(
    ...
    '<div class="text">',
    '<span>{[values.title.shorten(20)]}</span>',
    '<span class="thumb-type">{[Phlexible.mediatype.MediaTypes.getText(values.media_type)]}</span>',
    '<span class="thumb-date">{time:date("Y-m-d H:i:s")}</span>',
    '</div>',
    '<div class="x-clear"></div>',
    '</div>',
...
Phlexible.mediamanager.portlet.LatestFilesListTemplate = new Ext.XTemplate(
    '<tpl for=".">',
    '<div class="thumb-wrap" id="media_last_{id}">',
    '<div class="thumb {[Phlexible.mediatype.MediaTypes.getClass(values.media_type)]}-small"></div>',
    '<div class="text">',
    '<span>{[values.title.shorten(60)]}</span>',
    '<br />',
    '<span class="thumb-date">{time:date("Y-m-d H:i:s")}, {[Phlexible.mediatype.MediaTypes.getText(values.media_type)]}</span>',
    '</div>',
    '<div class="x-clear"></div>',
    '</div>',
    '</tpl>'
