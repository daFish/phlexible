Ext.provide('Phlexible.mediamanager.templates.StartGroup');
Ext.provide('Phlexible.mediamanager.templates.UsedString');
Ext.provide('Phlexible.mediamanager.templates.NameString');
Ext.provide('Phlexible.mediamanager.templates.GridRowExtra');
Ext.provide('Phlexible.mediamanager.templates.GridRowLarge');
Ext.provide('Phlexible.mediamanager.templates.GridRowMedium');
Ext.provide('Phlexible.mediamanager.templates.GridRowSmall');
Ext.provide('Phlexible.mediamanager.templates.GridRowTile');
Ext.provide('Phlexible.mediamanager.templates.DragSingle');
Ext.provide('Phlexible.mediamanager.templates.DragMulti');
