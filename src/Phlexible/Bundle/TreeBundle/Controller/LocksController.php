...
class LocksController extends Controller
{
    ...
    {
        $lockManager = $this->get('phlexible_tree.node_lock_manager');
     ...
     * @Route("/delete/{id}", name="tree_locks_delete")
     */
     ...
     *
     * @return ResultResponse
     * @Route("/lock", name="tree_locks_lock")
     */
     ...
     *
     * @return ResultResponse
     * @Route("/unlock", name="tree_locks_unlock")
     */
     ...
     *
     * @return ResultResponse
     * @Route("/unlock/force", name="tree_locks_forceunlock")
     */
