Ext.provide('Phlexible.tree.tree.TreeNodeUI');

Phlexible.tree.tree.TreeNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
    // private
    ...
    onTextChange: function (node, text, oldText) {
        ...
        Phlexible.tree.tree.TreeNodeUI.superclass.onTextChange.call(this, node, text, oldText);
    },
    ...
    applyNodeConfigToText: function (n, a, text) {
        ...
        if (a.isRestricted) {
            //text = '[' + text + ']';
            text += ' <span style="color: red; padding: 0;">&#8416;</span>';
        }
