Ext.provide('Phlexible.tree.view.tab.Preview');

Phlexible.tree.view.tab.Preview = Ext.extend(Ext.Panel, {
    ...
    initToolbar: function() {
        ...
        Ext.each(Phlexible.Config.get('set.language.frontend'), function(lang) {
            langBtns.push({
                ...
                iconCls: lang[2],
                langKey: lang[0],
                checked: lang[0] === this.element.getLanguage()
            });
        }, this);
    ...
    onLoadElement: function (element) {
        if (element.getElementtypeType() == Phlexible.elementtypes.TYPE_FULL ||
            ...
            this.setOnlineUrl(this.element.getUrls().online);
...
Ext.reg('tree-tab-preview', Phlexible.tree.view.tab.Preview);
