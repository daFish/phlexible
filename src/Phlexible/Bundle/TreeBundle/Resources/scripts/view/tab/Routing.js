Ext.provide('Phlexible.tree.view.tab.Routing');

Phlexible.tree.view.tab.Routing = Ext.extend(Ext.form.FormPanel, {
    ...
    initComponent: function () {
        ...
        Phlexible.tree.view.tab.Routing.superclass.initComponent.call(this);
    ...
    onLoadElement: function (element) {
        ...
        this.getForm().setValues(this.element.getConfiguration().routing || {});
    },
...
Ext.reg('tree-tab-routing', Phlexible.tree.view.tab.Routing);
