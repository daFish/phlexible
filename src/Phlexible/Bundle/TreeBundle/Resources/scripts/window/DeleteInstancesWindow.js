Ext.provide('Phlexible.tree.window.DeleteInstancesWindow');

Ext.require('Ext.grid.CheckboxColumn');

Phlexible.tree.window.DeleteInstancesWindow = Ext.extend(Ext.Window, {
    ...
    initComponent: function () {
        ...
        Phlexible.tree.window.DeleteInstancesWindow.superclass.initComponent.call(this);
    }
});
