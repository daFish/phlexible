Ext.provide('Phlexible.tree.window.PublishSlaveWindow');

Ext.require('Ext.grid.CheckboxColumn');

Phlexible.tree.window.PublishSlaveWindow = Ext.extend(Ext.Window, {
    ...
    initComponent: function () {
        ...
        Phlexible.tree.window.PublishSlaveWindow.superclass.initComponent.call(this);
    }
});
