Ext.provide('Phlexible.tree.window.PublishTreeNodeWindow');

Ext.require('Ext.grid.CheckboxColumn');

Phlexible.tree.window.PublishTreeNodeWindow = Ext.extend(Ext.Window, {
    ...
    initComponent: function () {
        ...
        Phlexible.tree.window.PublishTreeNodeWindow.superclass.initComponent.call(this);
    },
