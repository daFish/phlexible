Ext.provide('Phlexible.tree.window.LocksWindow');

Phlexible.tree.window.LocksWindow = Ext.extend(Ext.Window, {
    ...
    initComponent: function () {
        ...
        Phlexible.tree.window.LocksWindow.superclass.initComponent.call(this);
    }
});
