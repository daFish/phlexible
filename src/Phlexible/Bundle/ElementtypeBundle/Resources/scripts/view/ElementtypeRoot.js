Ext.provide('Phlexible.elementtypes.ElementtypeRoot');

Ext.require('Phlexible.elementtypes.RootPropertyPanel');
Ext.require('Phlexible.elementtypes.RootMappingsPanel');
